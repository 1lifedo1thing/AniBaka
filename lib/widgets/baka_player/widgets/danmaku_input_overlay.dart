...
class _DanmakuInputOverlayState extends State<DanmakuInputOverlay>
  ...
  static const _types = <({int type, IconData icon, String tooltip})>[
    (type: 1, icon: Icons.sort_rounded, tooltip: '滚动'),
    (type: 5, icon: Icons.vertical_align_top_rounded, tooltip: '顶部'),
    (type: 4, icon: Icons.vertical_align_bottom_rounded, tooltip: '底部'),
  ];
  ...
  void _close() {
    _animController.reverse().then((_) {
      if (mounted && widget.controller.overlay.value.showDanmakuInput) {
      ...
      children: _colors.map((color) {
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            child: isSelected
                ? const Center(
                    child: Icon(Icons.check, size: 13, color: Colors.black54),
                  )
                : null,
          ),
        );
